...
def rapprocher_paiement_bo_basic(df_payment: pd.DataFrame,df_rebo_ordre_vir: pd.DataFrame,
    clientname_col: str=None,date_colname: str=None,amount_colname: str=None,payment_id: str=None,
...
def create_light_check(df_payment: pd.DataFrame, df_BO: pd.DataFrame, clientname_col: str=None,
